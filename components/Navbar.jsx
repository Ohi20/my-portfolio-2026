...
const Navbar = () => {
  ...
  const openMenu = () => {
    mobileMenuRef.current.style.transform = "translate(-16rem)";
  };
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]">
        <Image src={assets.header_bg_color} className="w-full" alt="bg-image" />
      </div>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button>
            <Image src={assets.moon_icon} alt="theme-button" className="w-6" />
          </button>
